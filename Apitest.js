...
window.addEventListener('DOMContentLoaded', () => {
    axios.get("https://crudcrud.com/api/d9d38068e32c41ec8f5b5f7a762e8238/expence")
        .then((response) => {
...
function addItem(e) {
    ...
    async function modifyList() {
        ...
        await axios.get("https://crudcrud.com/api/d9d38068e32c41ec8f5b5f7a762e8238/expence")
            .then((response) => {
                response.data.forEach((ele) => {
                    if (ele.discription == obj.discription) {
                        check(obj);
                        axios.delete("https://crudcrud.com/api/d9d38068e32c41ec8f5b5f7a762e8238/expence/"+`${ele._id}`)
                    }
                })
            })
        ...
        await axios.post("https://crudcrud.com/api/d9d38068e32c41ec8f5b5f7a762e8238/expence", obj)
            .then((response) => {
...
// https://crudcrud.com/api/ef039eccbd8c4acfbaed3f60f68b3be5/expence
